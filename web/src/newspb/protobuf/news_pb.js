...
proto.protobuf.Response = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.protobuf.Response.repeatedFields_, null);
};
...
proto.protobuf.Response.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.protobuf.New.toObject, includeInstance)
  };
...
proto.protobuf.Response.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      reader.readMessage(value,proto.protobuf.New.deserializeBinaryFromReader);
      msg.addNews(value);
      break;
    default:
      reader.skipField();
...
proto.protobuf.Response.prototype.addNews = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.protobuf.New, opt_index);
};
